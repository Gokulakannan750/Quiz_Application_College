...
namespace Quiz_Application_College.Migrations
{
    ...
    [Migration("20251205062323_AddSourceFileNameToMcqQuestion")]
    partial class AddSourceFileNameToMcqQuestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quiz_Application_College.Domain.Coding.CodingQuizFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Quiz_Application_College.Domain.McqQuizFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Quiz_Application_College.Domain.Quiz", b =>
                {
                    ...
                    b.Property<int?>("CodingQuizFolderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Quiz_Application_College.Domain.Quiz", b =>
                {
                    b.HasOne("Quiz_Application_College.Domain.Coding.CodingQuizFolder", "CodingQuizFolder")
                        .WithMany("Quizzes")
                        .HasForeignKey("CodingQuizFolderId");

                    b.HasOne("Quiz_Application_College.Domain.McqQuizFolder", "McqQuizFolder")
                        .WithMany("Quizzes")
                        .HasForeignKey("McqQuizFolderId");

                    b.Navigation("CodingQuizFolder");
